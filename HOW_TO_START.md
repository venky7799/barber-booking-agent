...
Shop **Hours** in the Google Sheet drive the WhatsApp time list (booked slots are hidden). If a time is taken while they are choosing, they get a fresh list for that day and pick another. On confirm, **Confirm** / **Cancel** only; saying “no, 7pm” tries that time instead of cancelling.
